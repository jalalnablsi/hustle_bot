...
export async function GET(req: NextRequest) {
  try {
    ...
    console.log("API /auth/me: Received request. Cookie tgUser:", tgUserCookie ? "Present" : "MISSING");
    ...
    console.log(`API /auth/me: Attempting to fetch user by DB ID from cookie: ${userIdFromCookie}`);
    ...
    console.log(`API /auth/me: Successfully fetched user ${sanitizedUser.id}.`);
