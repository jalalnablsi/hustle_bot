...
export type GameDifficulty = 'easy' | 'medium' | 'hard' | 'very_hard';
...
export interface User {
  ...
  payment_wallet_address?: string | null; // Added from AppUser
  payment_network?: string | null; // Added from AppUser
  daily_ad_views_limit?: number; // Added from AppUser
...
export type AppUser = User; // Simplified User to be the main type
...
// New type for External Games
export interface ExternalGame {
  id?: string; // Optional for creation, will be generated by DB
  title: string;
  iframe_url: string;
